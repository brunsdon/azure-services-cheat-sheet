...
Start here when browsing the Azure Services Cheat Sheet by topic.

## Recommended Learning Order

1. [Service Selection Guide](service-selection-guide.md)
2. [Messaging](messaging.md)
3. [Integration](integration.md)
4. [Architecture Patterns](architecture-patterns.md)
...
| [Repository Notes](promotion-notes.md)                              | Description, topics, and sharing notes.           |
