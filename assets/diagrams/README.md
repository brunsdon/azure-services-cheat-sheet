...
- Keep Mermaid source in the markdown file where possible.
- Export SVG or PNG only when needed.
- Do not include sensitive architecture details.
- Prefer clear labels over decorative visuals.
